...
def c_print_results(name,
	...
	print("\n Hardware:")
	print("    CPU device   = %s" % (cpuinfo.get_cpu_info()['brand_raw']))
	print("    GPU device   = %s" % (gpu_device.decode('UTF-8') if (type(gpu_device) == bytes) else gpu_device))
	print("\n Software:");
	print("    Parameters   = %s" % (gpu_config))
	...
	print("----------------------------------------------------------------------")
	print("    NPB-PYTHON-CUDA is developed by:")
